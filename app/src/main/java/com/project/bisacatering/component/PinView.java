...
public class PinView extends AppCompatEditText {
    ...
    public PinView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        mPinItemHeight = (int) a.getDimension(com.chaos.view.R.styleable.PinView_itemHeight,
                res.getDimensionPixelSize(com.chaos.view.R.dimen.pv_pin_view_item_size));
        mPinItemWidth = (int) a.getDimension(com.chaos.view.R.styleable.PinView_itemWidth,
                res.getDimensionPixelSize(com.chaos.view.R.dimen.pv_pin_view_item_size));
        mPinItemSpacing = a.getDimensionPixelSize(com.chaos.view.R.styleable.PinView_itemSpacing,
                res.getDimensionPixelSize(com.chaos.view.R.dimen.pv_pin_view_item_spacing));
        mPinItemRadius = (int) a.getDimension(com.chaos.view.R.styleable.PinView_itemRadius, 0);
        mLineWidth = (int) a.getDimension(com.chaos.view.R.styleable.PinView_lineWidth,
                res.getDimensionPixelSize(com.chaos.view.R.dimen.pv_pin_view_item_line_width));
        mLineColor = a.getColorStateList(com.chaos.view.R.styleable.PinView_lineColor);
        isCursorVisible = a.getBoolean(com.chaos.view.R.styleable.PinView_android_cursorVisible, true);
        mCursorColor = a.getColor(com.chaos.view.R.styleable.PinView_cursorColor, getCurrentTextColor());
        mCursorWidth = a.getDimensionPixelSize(com.chaos.view.R.styleable.PinView_cursorWidth,
                res.getDimensionPixelSize(com.chaos.view.R.dimen.pv_pin_view_cursor_width));

        mItemBackground = a.getDrawable(com.chaos.view.R.styleable.PinView_android_itemBackground);
        mHideLineWhenFilled = a.getBoolean(com.chaos.view.R.styleable.PinView_hideLineWhenFilled, false);
    ...
    private void drawPinView(Canvas canvas) {
        ...
        Log.d("Pin", String.valueOf(highlightIdx));
        for (int i = 0; i < mPinItemCount; i++) {
            ...
            if(i <= highlightIdx){
                ...
                mPaint.setColor(mLineColor.getDefaultColor());
            }
